  ...
  return (
    <div id="about" className="flex flex-col gap-20 items-center m-20">
      ...
      <div className="w-full flex flex-col md:flex-row md:gap-10">
        <div className="md:w-1/3 flex flex-col justify-start items-center border-2 border-gray-500 rounded-2xl p-10 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:translate-y-2">
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap gap-2">
            ...
            <SkillIcon icon={<IoLogoJavascript size={32} />} text="JavaScript" />
            ...
            <SkillIcon icon={<BiLogoSpringBoot size={32} />} text="Spring Boot" />
        ...
        <div className="md:w-2/3 flex flex-col gap-4">
          <div className="flex flex-col md:flex-row gap-4">
            <InfoBlock
              icon={<LuBrainCircuit size={32} className="text-4xl text-blue-600 mb-4" />}
              title="Experience"
              content={[
            ...
            />
            <InfoBlock
              icon={<MdCastForEducation size={32} className="text-4xl text-blue-600 mb-4" />}
              title="Education"
              content={[
                "1.5 years of Professional Work Experience",
                "Full Stack Web Development",
...
const SkillIcon: React.FC<{ icon: JSX.Element; text: string }> = ({ icon, text }) => (
...
const InfoBlock: React.FC<{ icon: JSX.Element; title: string; content: string[] }> = ({
  icon,
  title,
  content,
}) => (
